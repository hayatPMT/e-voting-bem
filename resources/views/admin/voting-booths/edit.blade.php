...
<div class="row mb-4">
 <div class="col-12 text-center">
  <h1 class="h3 font-weight-bold text-gray-800">Edit Bilik Voting</h1>
  <p class="text-muted small">Perbarui informasi lokasi pemungutan suara.</p>
 </div>
</div>
 ...
 <div class="col-lg-6">
  <div class="card card-outline card-warning shadow-lg border-0">
   <div class="card-header border-0 bg-transparent py-4 text-center pb-0">
    ...
    <h5 class="font-weight-bold text-dark mb-0">Formulir Edit Bilik</h5>
   </div>
    ...
    <form action="{{ route('admin.voting-booths.update', $booth->id) }}" method="POST">
     ...
     <div class="form-group mb-4">
      ...
      <div class="input-group input-group-merge border rounded-lg overflow-hidden shadow-sm">
       ...
       <input type="text" name="nama_booth" id="nama_booth" class="form-control border-0 pl-2 py-4" placeholder="Contoh: Bilik 01" value="{{ old('nama_booth', $booth->nama_booth) }}" required autofocus>
      </div>
      @error('nama_booth')
     ...
     <div class="form-group mb-4">
      ...
      <div class="input-group input-group-merge border rounded-lg overflow-hidden shadow-sm">
       ...
       <input type="text" name="lokasi" id="lokasi" class="form-control border-0 pl-2 py-4" placeholder="Contoh: Gedung A, Lantai 1" value="{{ old('lokasi', $booth->lokasi) }}">
      </div>
      @error('lokasi')
      <small class="text-danger font-weight-bold mt-1 d-block"><i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}</small>
      @enderror
