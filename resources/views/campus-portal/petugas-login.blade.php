...
<head>
    ...
    <title>Login Petugas | {{ $kampus->nama }}</title>
...
<body>
    <div id="page-loader">
        <div class="loader-content">
            <div class="loader-icon"><i class="fas fa-clipboard-list fa-spin"></i></div>
            <h5 style="color: var(--dark-color); font-weight: 800;">Login Petugas</h5>
    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <div class="login-body">
                ...
                <form method="POST"
        action="{{ route('campus.petugas.authenticate', $kampus->slug) }}">
    @csrf

    <div class="form-group">
        <label for="email">
            <i class="fas fa-envelope"></i> Email Petugas
        </label>
        <input type="email" id="email" name="email" class="form-control @error('email') is-invalid @enderror"
            placeholder="petugas@kampus.ac.id" required autofocus value="{{ old('email') }}">
        @error('email')
    ...
    <div class="login-footer">
        <div class="footer-badge">
            ...
            Petugas Daftar Hadir – {{ $kampus->nama }}
        </div>
    </div>
    </div>
    </div>
