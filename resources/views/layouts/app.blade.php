...
<head>
    ...
    <style>
        ...
        .nav-sidebar .nav-link > .right { font-size: 0.75rem; }
        .content-header { padding-bottom: 0.5rem; }
        .card-header { font-weight: 600; }
        .small-box { border-radius: 0.5rem; overflow: hidden; }
        .small-box .icon { opacity: 0.9; }
        .main-sidebar { box-shadow: 2px 0 8px rgba(0,0,0,.1); }
        .navbar-primary { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%) !important; }
        .navbar-primary .nav-link { color: rgba(255,255,255,.9) !important; }
        .navbar-primary .nav-link:hover { color: #fff !important; background: rgba(255,255,255,.1) !important; }
    </style>
    @stack('styles')
</head>
