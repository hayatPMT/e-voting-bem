    ...
    <style>
        ...
        * {
        ...
        .main-title {
            font-size: 2.75rem;
            font-weight: 800;
            background: linear-gradient(135deg, {{ $kampus->primary_color ?? 'var(--primary-color)' }}, {{ $kampus->secondary_color ?? 'var(--secondary-color)' }});
...
<body>
    ...
    <div id="page-loader">
        <div class="loader-content">
            ...
            <h5 class="font-weight-bold" style="color: var(--dark-color); font-weight: 800; letter-spacing: -0.5px;">
                E-Voting BEM</h5>
        </div>
    </div>
    ...
    <div class="container px-3">
        <div class="mode-selection-card">
            ...
            <div class="header-section">
                <div class="logo-icon"
                    style="background: linear-gradient(135deg, {{ $kampus->primary_color ?? '#667eea' }}, {{ $kampus->secondary_color ?? '#764ba2' }});">
                    <i class="fas fa-vote-yea"></i>
                </div>
                <h1 class="main-title">E-Voting BEM</h1>
                <h4 class="font-weight-bold mb-2" style="color: {{ $kampus->primary_color ?? '#667eea' }};">
                    {{ $kampus->nama ?? 'Semua Kampus' }}</h4>
                ...
                <div class="alert-box">
                    ...
                    @if (isset($tahapan))
                        <p>
                            ...
                            <strong>Waktu:</strong> {{ $tahapan->waktu_mulai->format('d M Y H:i') }} -
            ...
            <div class="footer-links">
                <a href="{{ route('public.chart') }}?kampus_id={{ $kampus->id }}">
                ...
                <a href="{{ route('landing') }}" class="text-muted">
                    <i class="fas fa-university"></i> Ganti Kampus
                </a>
            </div>
        </div>
    </div>
