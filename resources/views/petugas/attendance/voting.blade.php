...
@section('content')
    ...
    <div class="container-fluid px-3 px-md-4" style="max-width: 1400px;">
            ...
            <div class="col-lg-10">
                <div id="countdown-widget" class="text-center position-relative overflow-hidden pt-4 pb-5 pl-4 pr-4"
                    ...
                    <h3 id="countdown-title" class="font-weight-bold mb-5"
                        style="color: #1f2937; font-size: 1.8rem; letter-spacing: -0.5px;">Sisa Waktu Voting</h3>
                ...
                <div class="col mb-4">
                    <div class="card candidate-card h-100 border-0"
                        ...
                        <div class="card-body d-flex flex-column p-4" style="background: white;">
                            ...
                            <!-- Vote Button -->
                            <div class="mt-auto">
                                <form action="{{ route('voting-booth.vote', $attendance->session_token) }}"
                                    method="POST">
                                    @csrf
        ...
        <!-- Abstain Option Offline -->
        @if (count($kandidat) > 0)
            <div class="row mt-5 mb-5 justify-content-center" style="max-width: 800px; margin: 0 auto;">
                <div class="col-12 text-center">
                    <div class="p-4 p-md-5"
                        ...
                        <h4 class="mb-2" style="color: #374151; font-weight: 800;">Tidak Menemukan Pilihan yang Sesuai?
                        </h4>
                            ...
                            <div class="col-md-8">
                                <div class="bg-white p-4"
                                    ...
                                    <div class="mb-4 p-3"
                                        ...
                                        <p class="mb-0"
                                            style="color: #4b5563; line-height: 1.8; white-space: pre-line;">
                                            {{ $k->visi }}</p>
                                    </div>
                                    <div class="p-3"
                                        ...
                                        <div style="color: #4b5563; line-height: 1.8; white-space: pre-line;">
                                            {{ $k->misi }}</div>
                                    </div>
                                </div>
                            </div>
    ...
    <div id="countdown-data" data-now="{{ now()->timestamp * 1000 }}"
            ...
            function updateTimerDisplay() {
                ...
                if (now > endTime) {
                    ...
                    if (messageText) messageText.innerHTML =
                        '<i class="fas fa-flag-checkered mr-2"></i>Waktu Voting Telah Selesai';
