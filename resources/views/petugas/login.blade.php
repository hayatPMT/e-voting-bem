...
<body>
    ...
    <div id="page-loader">
        <div class="loader-content">
            ...
            <h5 class="font-weight-bold" style="color: var(--dark-color); font-weight: 800; letter-spacing: -1px;">
                E-Voting BEM</h5>
        </div>
    </div>
    ...
    <div class="container px-3">
        <div class="login-card">
            <div class="login-header">
                ...
                <h5 class="mb-2" style="font-weight: 700; color: {{ $kampus->primary_color ?? '#667eea' }};">
                    {{ $kampus->nama ?? 'E-Voting BEM' }}</h5>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="email" class="form-control @error('email') is-invalid @enderror" id="email"
                            name="email" value="{{ old('email') }}" placeholder="petugas@evoting.com" required
                            autofocus>
                    </div>
                </div>
