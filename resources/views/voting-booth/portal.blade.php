    ...
    <div class="row min-vh-100 align-items-center justify-content-center py-5">
        <div class="col-md-10 col-lg-8">
            <div class="text-center mb-5">
                <div class="mb-4">
                    <i class="fas fa-desktop text-primary"
                        style="font-size: 5rem; filter: drop-shadow(0 10px 15px rgba(0,0,0,0.1));"></i>
                </div>
                <h1 class="display-4 font-weight-bold text-dark mb-2">Portal Bilik Suara</h1>
                <h4 class="font-weight-bold" style="color: var(--gold, #d4af37);">{{ $kampus->nama ?? 'Semua Kampus' }}</h4>
            ...
            <div class="row">
                            ...
                            <div class="card border-0 shadow-sm hover-lift h-100"
                                ...
                                <div class="card-body p-4 text-center">
                                    ...
                                    <p class="text-muted mb-3"><i
                                            class="fas fa-map-marker-alt mr-2 text-danger"></i>{{ $booth->lokasi ?? 'Lokasi Umum' }}
                                    </p>

                                    <div class="btn btn-primary btn-block py-2 font-weight-bold"
                ...
                @empty
                    <div class="col-12 text-center py-5 bg-white shadow-sm rounded-lg" style="border-radius: 20px;">
                        ...
                        <p class="text-muted">Silakan hubungi administrator untuk menambah atau mengaktifkan bilik suara.
                        </p>
                    </div>
                @endforelse
            </div>
            ...
            <div class="mt-5 text-center">
                <a href="{{ route('voting-booth.portal') }}" class="btn btn-link text-muted">
                    <i class="fas fa-chevron-left mr-2"></i> Ganti Kampus
                </a>
            </div>
        </div>
    </div>
